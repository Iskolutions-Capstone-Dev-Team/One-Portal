...
VARS="VITE_API_BASE_URL VITE_BACKEND_URL VITE_PROXY_TARGET_URL VITE_BACKEND_API_KEY VITE_CLIENT_ID VITE_REDIRECT_URI VITE_CLIENT_SECRET VITE_LOGIN_PAGE_URL VITE_REGISTER_PAGE_URL"
