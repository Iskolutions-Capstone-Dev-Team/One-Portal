            ...
            <CardContent className="flex flex-col lg:flex-row lg:items-end justify-between gap-4 lg:gap-6 p-4 sm:p-5 w-full">
                <div className="flex-1 w-full text-center lg:text-left mb-2 lg:mb-0 lg:pb-1">
                    <h1 className="scroll-m-20 text-2xl sm:text-3xl font-bold tracking-tight mb-1 text-slate-900 dark:text-white">
                        Welcome back,
                        <span className="text-[#7b0d15] dark:text-red-500"> PUPTian!</span>
                    </h1>
                ...
                <div className="w-full lg:w-[400px] shrink-0 flex flex-col gap-2 relative">
                    ...
                    <Field className="w-full">
                      <InputGroup className="rounded-md h-10 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 shadow-sm focus-within:outline-none focus-within:ring-2 focus-within:ring-slate-300 dark:focus-within:ring-slate-600 focus-within:border-slate-300 dark:focus-within:border-slate-600 overflow-hidden w-full">
