...
export function SecurityNoteIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
...
export function CopiedCodesIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">
...
export function AuthenticatorAppIcon({ className }) {
    return (
...
export function PasskeyIcon({ className }) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true" className={className}>
...
export function AuthenticatorTypeIcon({ type, className }) {
    return String(type || "").toLowerCase() === "passkey"
        ? <PasskeyIcon className={className} />
        : <AuthenticatorAppIcon className={className} />;
}
